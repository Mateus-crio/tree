...
class TableScraper:
    ...
    def scrape_data(self):
        try:
            ...
            table = soup.find('div',table_id)
            print(table)
            if table:
                # Extrair dados da tabela usando pandas
                self.data = pd.read_html(str(table))
    ...
    def store_in_database(self, cursor, table_name):
        if self.data is not None:
            ...
            # Deletar todos os dados existentes na tabela
...
if __name__ == "__main__":
    url = 'https://mateus-crio.github.io/soma/patrimonios.html'
    host = 'localhost'
    user = 'senai'
    password = 'Senai125@'
    database = 'basedados'
